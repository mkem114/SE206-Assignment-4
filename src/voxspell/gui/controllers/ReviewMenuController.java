...
/**
 * <h1>voxspell.gui.controllers.ReviewMenuController</h1> Controller class with level selection tools
...
public class ReviewMenuController implements Initializable {
	...
	void goReview(ActionEvent event) {
		...
		try {
			...
			loader.setLocation(App.class.getResource("views/ReviewGame.fxml"));
